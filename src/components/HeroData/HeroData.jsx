...
const HeroData = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">Hi, I'm Rudrika Panigrahi
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
            ...
            <p className="home__description">I am a Frontend Developer based in India.</p>
            <a href="#contact" className="button button--flex"><i class="uil uil-message "></i>
              Say Hello
            <svg
                  class="button__icon"
                  xmlns="http://www.w3.org/2000/svg"
